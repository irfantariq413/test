...
class MAE_Fancy_Image_Widget extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .master-fancy-image.reveal:after' => 'background-color: {{VALUE}};',
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .master-video-icon a:after' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
        );
	...
	protected function render() {
		...
		$cls = '';
		if ($settings['stretch']) $cls = 'stretch-'. $settings['stretch'];
