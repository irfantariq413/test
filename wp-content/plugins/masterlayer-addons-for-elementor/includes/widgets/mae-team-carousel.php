...
class MAE_Team_Carousel_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'role',
            [
                'label'   => __( 'Member Position', 'masterlayer' ),
                'type'    => Controls_Manager::TEXT,
    ...
    protected function render() {
        ...
        <div class="master-carousel-box master-team-carousel <?php echo esc_attr( $cls ); ?>" <?php echo $data; ?>>
            <?php
            foreach ( $teams as $index => $item ) { 
                ...
                // Socials
                if ( ($item['facebook'] == 'true') && $item['facebook_url'])
                    $socials .= sprintf('<a href="%1$s" class="fab fa-facebook-f"></a>', esc_url($item['facebook_url']['url']));

                if ( ($item['twitter'] == 'true') && $item['twitter_url'])
                    $socials .= sprintf('<a href="%1$s" class="fab fa-twitter"></a>', esc_url($item['twitter_url']['url']));

                if ( ($item['instagram'] == 'true') && $item['instagram_url'])
                    $socials .= sprintf('<a href="%1$s" class="fab fa-instagram"></a>', esc_url($item['instagram_url']['url']));
                
                if ( ($item['linkedin'] == 'true') && $item['linkedin_url'])
                    $socials .= sprintf('<a href="%1$s" class="fab fa-linkedin-in"></a>', esc_url($item['linkedin_url']['url']));
