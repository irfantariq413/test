...
class MAE_Link_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'icon_offset_left',
            [
                'label'      => __( 'Icon Offset Left', 'masterlayer' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .master-link .icon ' => 'left: {{SIZE}}{{UNIT}}',
                ],
                50,
                'condition' => [
                    'link_icon_position!' => 'none'
        ...
        $this->add_responsive_control(
            'icon_offset_top',
            [
                'label'      => __( 'Icon Offset Top', 'masterlayer' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px'],
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .master-link .icon ' => 'top: {{SIZE}}{{UNIT}}',
                ],
                50,
                'condition' => [
                    'link_icon_position!' => 'none'
