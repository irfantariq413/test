...
class WPRT_recent_news extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        if ( isset( $thumb_width ) ) {
            $thumb_css .= 'width:'. $thumb_width .'px;';
				...
				<li class="clearfix" style="<?php echo esc_attr( $item_css ); ?>">
                    ...
                    <div class="thumb <?php echo esc_attr( $thumb_style ); ?>" style="<?php echo esc_attr( $thumb_css ); ?>">
                        <?php
                            ...
                            $size = 'sublime-post-widget';

                            if ( has_post_thumbnail() ) {
                                the_post_thumbnail( $size );
                            } elseif ( get_post_format() == 'gallery' ) {
                                $images = sublime_metabox( 'gallery_images', "type=image&size=$size" );
                    ...
                    if ( ! empty( $title_length ) ) {
                        //$title = sublime_trim_words( $title, $title_length );
                    }
...
add_action( 'widgets_init', 'register_sublime_recent_news' );

// Register widget
function register_sublime_recent_news() {
