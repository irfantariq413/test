...
// Define vars
$logo_size = '';
$logo_cls = sublime_get_mod( 'logo_extra' );
$logo_url = home_url( '/' );
$logo_title = get_bloginfo( 'name' );

$logo_img = sublime_get_mod( 'custom_logo' );
$logo_width = sublime_get_mod( 'logo_width' );
$logo_margin = sublime_get_mod( 'logo_margin' );

// if page has custom logo
if ( is_page() ) {
	$custom_logo = sublime_elementor( 'custom_logo' );
	if ( $custom_logo ) {
		if ( $custom_logo['url'] ) {
