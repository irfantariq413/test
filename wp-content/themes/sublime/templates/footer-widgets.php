...
if ( ! sublime_get_mod( 'footer_widgets', true ) )
	return false;

// Get defaults from Customizer
$columns = sublime_get_mod( 'footer_columns', '4' );
$gutter = sublime_get_mod( 'footer_column_gutter', '30' );
...
<footer id="footer" class="sticky-stopper" style="<?php echo sublime_footer_bg(); ?>">	
