...
function sublime_standard_fonts() {
	return array(
...
function sublime_google_fonts_array() {
...
function sublime_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = sublime_google_fonts_array();
	...
	// Subset
	$subset = sublime_get_mod( 'google_font_subsets', 'latin' );
	...
	// Enqueue style
	wp_enqueue_style( 'sublime-google-font-'. $handle, $url, false, false, 'all' );
}