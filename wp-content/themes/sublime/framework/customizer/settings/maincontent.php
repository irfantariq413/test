...
$this->sections['sublime_maincontent_general'] = array(
	'title' => esc_html__( 'General', 'sublime' ),
	'panel' => 'sublime_maincontent',
	'settings' => array(
		array(
...
// Main Content Left
$this->sections['sublime_maincontent_left'] = array(
	'title' => esc_html__( 'Content', 'sublime' ),
	'panel' => 'sublime_maincontent',
	'settings' => array(
		array(
			...
			'control' => array (
				...
				'description' => esc_html__( 'Top Right Bottom Left. Example: 30px', 'sublime' ),
			),
			'inline_css' => array(
...
// Main Content Right
$this->sections['sublime_maincontent_right'] = array(
	'title' => esc_html__( 'Sidebar', 'sublime' ),
	'panel' => 'sublime_maincontent',
	'settings' => array(
		array(
		...
		array(
			...
			'control' => array (
				'type' => 'text',
				'label' => esc_html__( 'Border Width', 'sublime' ),
				'description' => esc_html__( 'Top Right Bottom Left. Example: 0px 3px 3px 0px', 'sublime' ),
			),
			'inline_css' => array(
				'target' => '.sidebar-left #sidebar, .sidebar-right #sidebar',
				'alter' => 'border-width',
