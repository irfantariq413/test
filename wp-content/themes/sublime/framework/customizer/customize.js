...
var objBg = {
	...
	header_background: "#site-header:after",
...
var objColor = {
	...
	menu_link_color: ".header-style-1 #main-nav > ul > li > a > span",
	menu_link_color_hover: ".header-style-1 #main-nav > ul > li > a:hover > span",
	menu_link_color2: ".header-style-2 #main-nav > ul > li > a > span",
	menu_link_color_hover2: ".header-style-2 #main-nav > ul > li > a:hover > span",
	menu_link_color3: ".header-style-3 #main-nav > ul > li > a > span",
	menu_link_color_hover3: ".header-style-3 #main-nav > ul > li > a:hover > span",
...
var objBorderColor = {
	...
	blog_entry_border_color: ".post.hentry",
...
var objBorderWidth = {
	...
	blog_entry_border_width: ".post.hentry",
...
var objPadding = {
	...
	blog_entry_content_padding: ".post.hentry",
...
var objWidth = {
	...
	site_desktop_container_width: ".site-layout-full-width .sublime-container, .site-layout-boxed #page",
...
var objTopMargin = {
	...
	blog_entry_bottom_margin: ".post.hentry",
...
var headersPadding = {
	header_padding: ".site-header-inner"
}
...
wp.customize("featured_title_padding", function(e) {
    e.bind(function(e) {
        ...
        if (e) {
            var t = '<style class="customizer-featured_title_padding">@media only screen and (min-width: 992px) { #featured-title .inner-wrap, .header-style-2 #featured-title .inner-wrap, .header-style-3 #featured-title .inner-wrap { padding: ' + e + "; } }</style>";
            o.length ? o.replaceWith(t) : $("head").append(t)
        } else o.remove()
    })
});
...
wp.customize("mobile_featured_title_padding", function(e) {
    e.bind(function(e) {
        ...
        if (e) {
            var t = '<style class="customizer-mobile_featured_title_padding">@media only screen and (max-width: 991px) { #featured-title .inner-wrap,.header-style-2 #featured-title .inner-wrap,.header-style-3 #featured-title .inner-wrap { padding: ' + e + "; } }</style>";
            o.length ? o.replaceWith(t) : $("head").append(t)
        } else o.remove()
    })
});
